...
public class EntryUtil {
	...
	public static Entry findByUuid_First(
		...
		throws com.liferay.test.exception.NoSuchEntryException {
	 ...
	 * @return the matching entries
	 */
	public static List<Entry> findByG_G(long guestBookId, long groupId) {
		return getPersistence().findByG_G(guestBookId, groupId);
	}
	...
	public static List<Entry> findByG_G(
		...
		return getPersistence().findByG_G(guestBookId, groupId, start, end);
	}
	...
	public static Entry[] findByG_G_PrevAndNext(
		...
		return getPersistence().findByG_G_PrevAndNext(
			entryId, guestBookId, groupId, orderByComparator);
	}
	 ...
	 * @param groupId the group ID
	 */
	public static void removeByG_G(long guestBookId, long groupId) {
		getPersistence().removeByG_G(guestBookId, groupId);
	}
	 ...
	 * @return the number of matching entries
	 */
	public static int countByG_G(long guestBookId, long groupId) {
		return getPersistence().countByG_G(guestBookId, groupId);
	}
