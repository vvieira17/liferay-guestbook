...
import com.liferay.test.model.EntryModel;
...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	...
	public static final String TABLE_SQL_CREATE =
		"create table Entry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,email VARCHAR(75) null,message VARCHAR(75) null,guestBookId LONG)";
	...
	static {
		...
		columnBitmasks.put("guestBookId", 2048L);
