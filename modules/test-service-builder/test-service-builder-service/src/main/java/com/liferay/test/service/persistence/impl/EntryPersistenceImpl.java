...
import com.liferay.test.exception.NoSuchEntryException;
import com.liferay.test.model.Entry;
import com.liferay.test.model.EntryTable;
import com.liferay.test.model.impl.EntryImpl;
import com.liferay.test.model.impl.EntryModelImpl;
import com.liferay.test.service.persistence.EntryPersistence;
import com.liferay.test.service.persistence.EntryUtil;
import com.liferay.test.service.persistence.impl.constants.gbPersistenceConstants;
...
public class EntryPersistenceImpl
	...
	/**
	 * Returns all the entries where guestBookId = &#63; and groupId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Entry> findByG_G(long guestBookId, long groupId) {
		return findByG_G(
			guestBookId, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the entries where guestBookId = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EntryModelImpl</code>.
	 * </p>
	...
	public List<Entry> findByG_G(
		long guestBookId, long groupId, int start, int end) {

		return findByG_G(guestBookId, groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the entries where guestBookId = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EntryModelImpl</code>.
	 * </p>
	...
	public List<Entry> findByG_G(
		...
		return findByG_G(
			guestBookId, groupId, start, end, orderByComparator, true);
	}
	...
	public List<Entry> findByG_G(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {guestBookId, groupId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_G;
			finderArgs = new Object[] {
				guestBookId, groupId, start, end, orderByComparator
			};
		}
	...
	/**
	 * Returns the first entry in the ordered set where guestBookId = &#63; and groupId = &#63;.
	 *
	 * @param guestBookId the guest book ID
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Entry findByG_G_First(
		...
		Entry entry = fetchByG_G_First(guestBookId, groupId, orderByComparator);
	...
	public Entry fetchByG_G_First(
		...
		List<Entry> list = findByG_G(
			guestBookId, groupId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last entry in the ordered set where guestBookId = &#63; and groupId = &#63;.
	 *
	 * @param guestBookId the guest book ID
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Entry findByG_G_Last(
		...
		Entry entry = fetchByG_G_Last(guestBookId, groupId, orderByComparator);
	...
	public Entry fetchByG_G_Last(
		...
		int count = countByG_G(guestBookId, groupId);
		...
		List<Entry> list = findByG_G(
			guestBookId, groupId, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the entries before and after the current entry in the ordered set where guestBookId = &#63; and groupId = &#63;.
	 *
	 * @param entryId the primary key of the current entry
	 * @param guestBookId the guest book ID
	 * @param groupId the group ID
	...
	public Entry[] findByG_G_PrevAndNext(
			long entryId, long guestBookId, long groupId,
			OrderByComparator<Entry> orderByComparator)
		throws NoSuchEntryException {
		...
		try {
			...
			array[0] = getByG_G_PrevAndNext(
				session, entry, guestBookId, groupId, orderByComparator, true);

			array[1] = entry;

			array[2] = getByG_G_PrevAndNext(
				session, entry, guestBookId, groupId, orderByComparator, false);
	...
	protected Entry getByG_G_PrevAndNext(
		Session session, Entry entry, long guestBookId, long groupId,
		OrderByComparator<Entry> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the entries where guestBookId = &#63; and groupId = &#63; from the database.
	 *
	 * @param guestBookId the guest book ID
	 * @param groupId the group ID
	 */
	@Override
	public void removeByG_G(long guestBookId, long groupId) {
		for (Entry entry :
				findByG_G(
					guestBookId, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of entries where guestBookId = &#63; and groupId = &#63;.
	 *
	 * @param guestBookId the guest book ID
	 * @param groupId the group ID
	 * @return the number of matching entries
	 */
	@Override
	public int countByG_G(long guestBookId, long groupId) {
		FinderPath finderPath = _finderPathCountByG_G;

		Object[] finderArgs = new Object[] {guestBookId, groupId};
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_G = new FinderPath(
			...
			new String[] {"guestBookId", "groupId"}, true);
		...
		_finderPathCountByG_G = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"guestBookId", "groupId"}, false);
